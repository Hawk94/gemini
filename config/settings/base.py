...
ROOT_DIR = environ.Path(__file__) - 3  # (gemini/config/settings/base.py - 3 = gemini/)
APPS_DIR = ROOT_DIR.path('gemini')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'gemini.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///gemini'),
}
...
########## CELERY
INSTALLED_APPS += ['gemini.taskapp.celery.CeleryConfig']
